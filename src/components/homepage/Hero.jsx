...
export default function Hero() {
  ...
  return (
    <div className="relative flex h-screen select-none items-center justify-center">
      <div className="z-10 flex flex-col overflow-hidden w-full border items-center text-title font-bold uppercase text-accent-300">
        <div className="title">
      ...
      >
        <img
          ref={img}
          className=" scale-110 aspect-[11/16] sm:aspect-[5/6] md:aspect-[8/7] rounded-md opacity-50 lg:aspect-[4/3]"
          src={heroImg}
          alt="Abstract cubic background image."
        />
      </div>
      <div ref={scroll} className="absolute bottom-12 right-2 flex flex-col items-center justify-center space-y-8">
