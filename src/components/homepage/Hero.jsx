...
export default function Hero() {
  ...
  return (
    <section className="hero relative flex w-full h-screen select-none items-center justify-center">
      ...
      >
        <img
          ref={img}
          className=" scale-110 aspect-[11/16] sm:aspect-[5/6] md:aspect-[8/7] rounded-md opacity-50 lg:aspect-[11/9]"
          src={heroImg}
